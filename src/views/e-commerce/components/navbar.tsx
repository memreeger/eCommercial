...
const Navbar: React.FC = () => {
  ...
  // Navbar dışına tıklanırsa menüleri kapatmak için ref ve handler
  ...
  // Shop butonuna tıklanınca shop menüyü toggle et
  const toggleShop = () => {
  ...
  return (
    <nav
      ref={navRef}
      className="w-full border-b bg-gray-900 text-gray-200"
    >
        ...
        >
          <li>
            <Link
              ...
              to="/"
              className="hover:text-blue-400 transition-colors block py-1 sm:py-0"
            >
              Home
            </Link>
          </li>
                ...
                {[
                  ...
                  <li key={item.to}>
                    <Link
                      onClick={handleLinkClick}
                      to={item.to}
                      className="px-4 py-2 rounded block hover:bg-blue-600 hover:text-white focus:bg-blue-600 focus:text-white transition-colors duration-200"
                    >
                      {item.label}
                    </Link>
                  </li>
